...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative min-h-screen pt-16 bg-gradient-to-b from-cream-100 to-cream-50">
      {/* Background Pattern */}
      ...
      <div className="relative max-w-7xl mx-auto px-4 py-8 md:py-16">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          {/* Rating Badge */}
          <div className="flex items-center gap-2 bg-white/80 backdrop-blur-sm px-4 py-2 rounded-full shadow-md mb-8 animate-fadeIn animation-delay-200">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 w-full max-w-2xl animate-fadeIn animation-delay-500">
            ...
            <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-4 shadow-md">
              <Clock className="text-amber-600 mb-2 mx-auto" size={28} />
            ...
            {/* Phone */}
            <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-4 shadow-md">
              <Phone className="text-amber-600 mb-2 mx-auto" size={28} />
            ...
            {/* Location */}
            <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-4 shadow-md">
              <MapPin className="text-amber-600 mb-2 mx-auto" size={28} />
